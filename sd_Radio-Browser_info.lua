--[[
 ...
 Radio-Browser.info lua script (service discovery)
...
function descriptor()
	return { title="Radio-Browser.info (Service Discovery)",
		description = "<center><b>Radio-Browser.info</b> (Service Discovery)</center>",
		version = "0.5",
